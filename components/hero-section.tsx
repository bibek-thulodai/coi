...
export default function HeroSection({
  ...
  subtitle,
  backgroundImage,
  backgroundColor = "#0e766e", // Changed to dark teal color
}: HeroSectionProps) {
  const [isVisible, setIsVisible] = useState(false)
  const sectionRef = useRef<HTMLElement>(null)
  const controls = useAnimation()

  // Removed mouse parallax effect with cursorAttachment
  ...
  useEffect(() => {
    ...
    const newParticles = Array.from({ length: 120 }, () => {
      ...
      if (colorChoice < 0.25) {
        color = "#0e766e" // Dark teal accent
      } else if (colorChoice < 0.5) {
        color = "#0f766e" // Dark teal accent
      } else if (colorChoice < 0.75) {
        color = "#14b8a6" // Light teal accent
      } else if (colorChoice < 0.95) {
        color = "#ffffff" // White
      } else {
        color = "#0d9488" // Accent highlight (teal)
      }
    ...
    const handleMouseMove = (e: MouseEvent) => {
      ...
      if (rect) {
        ...
        const rotX = (e.clientY - rect.top - rect.height / 2) / 15
        const rotY = (e.clientX - rect.left - rect.width / 2) / 15
  ...
  return (
    ...
    >
      ...
      {/* Background - removed parallax effect */}
      <div
      ...
      <motion.div
        className="absolute inset-0 bg-gradient-to-br from-[#0e766e]/40 via-[#0d9488]/30 to-[#14b8a6]/50"
        animate={{
          opacity: [0.7, 0.8, 0.7],
          background: [
      ...
      />
      <motion.div
        className="absolute inset-0 bg-gradient-to-tr from-[#0e766e]/20 via-transparent to-transparent"
        animate={{
          opacity: [0.2, 0.3, 0.2],
        }}
      ...
      />
      <motion.div
        className="absolute inset-0 bg-gradient-to-bl from-transparent via-transparent to-[#0e766e]/30"
        animate={{
          opacity: [0.3, 0.4, 0.3],
        }}
      ...
      <motion.div
        className="absolute top-1/3 right-1/4 w-4 h-4 rounded-full bg-[#0f766e] blur-sm"
        animate={{
          scale: [1, 1.5, 1],
          opacity: [0.6, 0.9, 0.6],
          x: [0, 20, 0],
      ...
      />
      <motion.div
        className="absolute bottom-1/4 left-1/3 w-3 h-3 rounded-full bg-[#0e766e] blur-sm"
        animate={{
          scale: [1, 1.8, 1],
          opacity: [0.5, 0.8, 0.5],
          x: [0, -15, 0],
      ...
      <div className="absolute inset-0 overflow-hidden">
        ...
        >
          ...
          >
            ...
            <motion.div
              className="absolute w-full h-full bg-gradient-to-br from-[#0e766e]/20 to-[#14b8a6]/10 backdrop-blur-sm border border-white/10 transform-style-3d transform translate-z-[30px]"
              animate={{
                boxShadow: [
                  "0 0 5px rgba(14,118,110,0.3)",
                  "0 0 15px rgba(14,118,110,0.5)",
                  "0 0 5px rgba(14,118,110,0.3)",
                ],
              }}
            ...
            />
            <motion.div
              className="absolute w-full h-full bg-gradient-to-br from-[#0e766e]/20 to-[#14b8a6]/10 backdrop-blur-sm border border-white/10 transform-style-3d transform rotate-y-90 translate-z-[30px]"
              animate={{
                boxShadow: [
                  "0 0 5px rgba(14,118,110,0.3)",
                  "0 0 15px rgba(14,118,110,0.5)",
            ...
            />
            <motion.div
              className="absolute w-full h-full bg-gradient-to-br from-[#0e766e]/20 to-[#14b8a6]/10 backdrop-blur-sm border border-white/10 transform-style-3d transform rotate-x-90 translate-z-[30px]"
              animate={{
                boxShadow: [
                  "0 0 5px rgba(14,118,110,0.3)",
                  "0 0 15px rgba(14,118,110,0.5)",
        ...
        >
          ...
          >
            ...
            <motion.div
              className="absolute left-0 top-0 w-full h-full border-t-0 border-l-[24px] border-r-[24px] border-b-[48px] border-l-transparent border-r-transparent border-b-[#14b8a6]/20 transform-style-3d transform -translate-y-1/2"
              animate={{
                borderBottomColor: ["rgba(20,184,166,0.2)", "rgba(20,184,166,0.4)", "rgba(20,184,166,0.2)"],
                filter: [
                  "drop-shadow(0 0 5px rgba(20,184,166,0.3))",
            ...
            />
            <motion.div
              className="absolute left-0 top-0 w-full h-full border-t-0 border-l-[24px] border-r-[24px] border-b-[48px] border-l-transparent border-r-transparent border-b-[#14b8a6]/20 transform-style-3d transform -translate-y-1/2 rotate-y-90"
              animate={{
                borderBottomColor: ["rgba(20,184,166,0.2)", "rgba(20,184,166,0.4)", "rgba(20,184,166,0.2)"],
                filter: [
                  "drop-shadow(0 0 5px rgba(20,184,166,0.3))",
            ...
            />
            <motion.div
              className="absolute left-0 top-0 w-full h-full border-t-0 border-l-[24px] border-r-[24px] border-l-transparent border-r-transparent border-b-[#14b8a6]/20 transform-style-3d transform -translate-y-1/2 rotate-y-180"
              animate={{
                borderBottomColor: ["rgba(20,184,166,0.2)", "rgba(20,184,166,0.4)", "rgba(20,184,166,0.2)"],
                filter: [
                  "drop-shadow(0 0 5px rgba(20,184,166,0.3))",
        ...
        >
          ...
          >
            <motion.div
              className="absolute inset-2 rounded-full border-2 border-[#0e766e]/20"
              animate={{
                boxShadow: [
                  "0 0 5px rgba(14,118,110,0.3)",
                  "0 0 15px rgba(14,118,110,0.5)",
        ...
        <div className="max-w-4xl">
          ...
          <div className="overflow-hidden mb-6 relative">
            ...
            >
              ...
              <motion.div
                className="absolute bottom-0 left-0 h-[3px] bg-gradient-to-r from-[#14b8a6] to-[#0e766e]"
                initial={{ width: 0 }}
                animate={{ width: "100%" }}
            ...
            <div className="absolute -right-8 top-1/2 w-6 h-[2px] bg-gradient-to-l from-[#0e766e] to-transparent"></div>

            {/* Enhanced decorative elements with glow */}
            <motion.div
              className="absolute -bottom-4 left-0 w-20 h-1 bg-gradient-to-r from-[#14b8a6] to-transparent"
              initial={{ width: 0 }}
              animate={{ width: "5rem" }}
            ...
            />
            <motion.div
              className="absolute -bottom-4 left-24 w-40 h-1 bg-gradient-to-r from-[#0e766e] to-transparent"
              initial={{ width: 0 }}
              animate={{ width: "10rem" }}
              transition={{ duration: 1.2, delay: 1.2 }}
              style={{
                boxShadow: "0 0 8px rgba(14,118,110,0.6)",
              }}
            />
          </div>
          ...
          {subtitle && (
            <div className="overflow-hidden relative">
              <motion.div
                className="absolute -left-4 top-1/2 w-3 h-3 rounded-full bg-[#14b8a6]"
              ...
              <motion.p
                ...
                style={{
                  boxShadow: "0 4px 20px rgba(14,118,110,0.3)",
                }}
              >
                {subtitle}
              </motion.p>
      ...
      >
        ...
        <motion.div
          className="w-8 h-14 border-2 border-[#0e766e]/30 rounded-full flex justify-center p-1 relative overflow-hidden"
          animate={{
            boxShadow: [
              "0 0 0px rgba(14,118,110,0.3)",
              "0 0 15px rgba(14,118,110,0.5)",
              "0 0 0px rgba(14,118,110,0.3)",
            ],
            borderColor: ["rgba(14,118,110,0.3)", "rgba(14,118,110,0.5)", "rgba(14,118,110,0.3)"],
          }}
          transition={{ duration: 2, repeat: Number.POSITIVE_INFINITY, repeatType: "loop" }}
        >
          <motion.div
            className="w-1.5 h-1.5 bg-[#0e766e] rounded-full relative z-10"
            animate={{ y: [0, 24, 0] }}
            transition={{ duration: 1.5, repeat: Number.POSITIVE_INFINITY, repeatType: "loop" }}
            style={{
              boxShadow: "0 0 10px rgba(14,118,110,0.8)",
            }}
          />
          <motion.div
            className="absolute inset-0 bg-gradient-to-b from-transparent via-[#0e766e]/30 to-transparent"
            animate={{ y: ["-100%", "100%"] }}
            transition={{ duration: 2, repeat: Number.POSITIVE_INFINITY, repeatType: "loop" }}
          />
        </motion.div>
      ...
      <style jsx global>{`
        ...
        .radial-glow {
          background: radial-gradient(circle, rgba(14,118,110,0.4) 0%, rgba(14,118,110,0) 70%);
        }
        .radial-glow-accent {
